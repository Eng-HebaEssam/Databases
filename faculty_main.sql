...
(7, 18, 1, 1, '2021-02-23', NULL, ''),
(8, 18, 4, 1, '2021-02-23', NULL, ''),
(9, 18, 3, 1, '2021-02-23', NULL, ''),
(10, 18, 0, 1, '2021-02-23', NULL, ''),
(11, 18, 0, 1, '2021-02-23', NULL, ''),
(12, 18, 0, 1, '2021-02-23', NULL, ''),
(13, 18, 4, 1, '2021-02-23', NULL, '');
...
(1, 'الفرقة الاعدادية', 'الفرقة الاعدادية', 1, 0, 1, 0, 0, '42165_french.jpg'),
(2, 'شعبة كهرباء عام', 'شعبة كهرباء عام', 2, 0, 1, 0, 0, '41665_french.jpg'),
(3, 'حاسبات ونظم تحكم', 'حاسبات ونظم تحكم', 3, 0, 1, 0, 0, '85683_french.jpg'),
(4, 'القوى والالات الكهربية', 'القوى والالات الكهربية', 4, 0, 1, 0, 0, '22515_french.jpg'),
(5, 'الاتصالات الكهربية والالكترونية', 'الاتصالات الكهربية والالكترونية', 5, 0, 1, 0, 0, '89728_french.jpg'),
(6, 'شعبة ميكانيكا عام', 'شعبة ميكانيكا عام', 6, 0, 1, 0, 0, '47631_french.jpg'),
(7, 'التصميم الميكانيكي وهندسة الانتاج', 'التصميم الميكانيكي وهندسة الانتاج', 7, 0, 1, 0, 0, '97579_francais-lettering-pink-background.jpg'),
(8, 'هندسة القوى الميكانيكيه', 'هندسة القوى الميكانيكيه', 8, 0, 1, 0, 0, '78571_francais-lettering-pink-background.jpg'),
(9, 'قسم الهندسة المدنية', 'قسم الهندسة المدنية', 9, 0, 1, 0, 0, '61072_francais-lettering-pink-background.jpg'),
(10, 'قسم الهندسة المعمارية', 'قسم الهندسة المعمارية', 10, 0, 1, 0, 0, '22839_francais-lettering-pink-background.jpg'),
(11, 'ميكاترونكس', 'ميكاترونكس', 11, 0, 1, 0, 0, '77518_francais-lettering-pink-background.jpg'),
(14, 'Microprocessor Systems ', '(Microprocessor Systems (1st Term 2019/2020', 0, 2, 1, 0, 0, '74481_microprocessor.jpg'),
(15, 'Digital Circuit Design', '(Digital Circuit Design (2ndTerm 2019/2020', 0, 2, 1, 0, 0, '14392_circuit-design-on-digital-background_1647006.jpg'),
(16, 'Automatic Control Systems', '.Introduction to Automatic Control Systems', 0, 8, 1, 0, 0, '82280_aucontrol.jpg'),
(17, 'القياسات واجهزة القياس الكهربية', 'القياسات واجهزة القياس الكهربية', 0, 2, 1, 0, 0, '85493_measurements3.jpg'),
(18, 'Electromagnetic Fields', 'Electromagnetic Fields', 0, 2, 1, 0, 0, '23623_dreamstime_l_4671381 (1).jpg');
...
(2, 'منشور جميل', '2021-02-15', 1, 1, 60, NULL, NULL),
(3, 'مقال جميل', '2021-02-15', 1, 1, 55, NULL, NULL),
(6, 'مقال جميل لكن عندى بعض الملاحظات', '2021-02-18', 1, 1, 55, NULL, NULL),
(7, 'واو', '2021-02-18', 1, 1, 60, NULL, NULL),
(8, 'dgdfxgdf', '2021-02-23', 0, 1, 55, NULL, NULL),
(9, 'vcxc', '2021-02-23', 0, 1, 60, NULL, NULL);
...
(16, 'امتحان مايكرو', '2021-02-22', 0, 1, 0, 'https://drive.google.com/file/d/16rSg-Av-zVPIXpDCGSwPF65eug_jXOaa/view?usp=sharing', NULL),
(17, 'امتحان مايكرو', '2021-02-22', 2, 1, 0, 'https://drive.google.com/file/d/16rSg-Av-zVPIXpDCGSwPF65eug_jXOaa/view?usp=sharing', NULL),
(18, 'امتحان مايكرو', '2021-02-22', 2, 1, 82, '', NULL);
...
(1, 'ahmed', '601f1889667efaebb33b8c12572835da3f027f78', 'amged@gmail.com', '', 2, 1, '2021-01-31', 'img.png', NULL, NULL, NULL, 2147483647, 1),
(235, 'abdoo', 'b08f6724cdbf47465e0791f8e41665bd13ae526d', 'abdulrhmanabouzaid@gmail.com', NULL, 11, 0, '2021-02-17', 'img.png', NULL, NULL, NULL, 1069043270, 0),
(238, 'mohamed', '601f1889667efaebb33b8c12572835da3f027f78', 'mah@gmail.com', NULL, 11, 0, '2021-02-23', 'img.png', NULL, NULL, NULL, 2147483647, 0);
...
(10, 'bmj b', NULL, '2021-02-22', 'cghgh', 'mastercode179@gmail.com'),
(11, 'fdzfdzgdzfgdf', 1, '2021-02-23', NULL, NULL);
...
(4, 18, 'The first micro-processor had a (n) ______.', '2021-02-23', '1-bit data bus', '2-bit data bus', '3-bit data bus', '4-bit data bus', '4', ''),
(5, 18, '__________ processor is first introduced by the Intel in 1971.', '2021-02-23', ' 8080', '4004', '8008', '8085', '2', ''),
(6, 18, 'Which of the following is/are 8-bit micro processo...', '2021-02-23', '8008', '8080', '8085', 'All of the mentioned', '4', ''),
(7, 18, 'The limitations of the 8-bit microprocessors was/w...', '2021-02-23', 'Low speed of execution', 'Low memory addressing capability', ' Less powerful instruction set', ' All of the mentioned', '4', ''),
(8, 18, 'The number of address and data lines of 8085 are__...', '2021-02-23', '8 and 8', '16 and 8', '8 and 16', '16 and 16', '4', '');
...
(2, 'cdazsds', '8IihsgPMNA', '2021-02-15 19:18:25'),
(3, 'aliens team', 'nfZ5KmTsIY', '2021-02-16 20:53:38'),
(4, 'abdulrhman', '2HHc0loqfs', '2021-02-17 20:23:46'),
(5, 'abdoo', '7kPBKR0nTd', '2021-02-17 20:28:28'),
(6, 'ahmed ali', 'CuRRnt4skD', '2021-02-17 20:37:14'),
(7, 'abdoo', '7kPBKR0nTd', '2021-02-17 20:41:44'),
(8, 'abdoo', '7kPBKR0nTd', '2021-02-17 20:45:35'),
(9, 'abdoo', '7kPBKR0nTd', '2021-02-17 20:49:05'),
(10, 'aaaaa', 'lzcov119eA', '2021-02-18 17:04:32'),
(11, 'hfhfcgahmed', 'QLD8JC68tG', '2021-02-23 11:54:47'),
(12, 'mohamed', 'jFZY0byXKf', '2021-02-23 13:08:45');
...
--
ALTER TABLE `members`
  MODIFY `userid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=239;
